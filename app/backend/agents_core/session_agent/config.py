...
- For raw DNA/protein sequence prompts, prefer run_retriever_compat_pipeline; it mirrors the legacy retriever flow but uses prepared graph lookup instead of runtime ProtT5/FAISS.
